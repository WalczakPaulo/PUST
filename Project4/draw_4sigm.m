...
%         mi2(k) = 1 - 1/(1+exp(-alfa*(y(k)-c)));
    ...
    figure
    plot(y, mi4)
    write_to_file('4_reg_sigm_1',y,mi1)
    write_to_file('4_reg_sigm_2',y,mi2)
    write_to_file('4_reg_sigm_3',y,mi3)
    write_to_file('4_reg_sigm_4',y,mi4)
end