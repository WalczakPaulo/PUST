...
Dla 3 regulatorów lokalnych użyliśmy sigmoidalnych funkcji przynależności, danych wzorami \ref{eq:mi1}, \ref{eq:mi2} i \ref{eq:mi3}. Parametry mają wartośi: $\alpha = -3$, $c^1 = -0,05$, $c^2=1,3$.
