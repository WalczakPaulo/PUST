...
if(to_file)
    write_to_file('dmc_y1_fmincon',1:kk,y(1,:))
    write_to_file('dmc_y2_fmincon',1:kk,y(2,:))
    write_to_file('dmc_y3_fmincon',1:kk,y(3,:))
    
    write_to_file('dmc_u1_fmincon',1:kk,u(1,:))
    write_to_file('dmc_u2_fmincon',1:kk,u(2,:))
    write_to_file('dmc_u3_fmincon',1:kk,u(3,:))
    write_to_file('dmc_u4_fmincon',1:kk,u(4,:))
